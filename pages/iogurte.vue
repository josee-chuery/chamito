<template>
 <section>
    ...
    <img src="https://www.nestle.com.br/sites/g/files/pydnoa436/files/2021-10/iogurte-100g.png">
      ...
      <div class="column is-6">
        <article class="notification is-info">
         <p class="title">Iogurte</p>
        </article>
        <article class="notification is-info">
         <p class="subtitle">Iogurte delicioso hummm</p>
        </article>
      </div>
      <div class="column is-3">
        <article class="notification is-info">
         <p class="title">10 bolsocoins</p>
         <p>Quantidade:</p>
        </article>
        <b-field>
   ...
   <div>
    <article class="notification is-info">
     <p class="subtitle">100g de iogurte cremoso</p>
    </article>
   </div>
   <br>
   <div>
    <article class="notification is-info">
     ...
     <br>
     <p class="subtitle">Clébinho: Melhor de todos!</p>
     <p class="subtitle">João: Topzera!</p>
    </article>
   </div>
   <br><br>
